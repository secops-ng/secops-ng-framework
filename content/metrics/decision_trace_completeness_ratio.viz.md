# Reference visualisation — `kpi.decision_trace_completeness_ratio@v1`

This is the committed reference-visualisation artifact for the
decision-trace completeness ratio across playbook branch outcomes KPI.
...
`ratio` aggregate for `kpi.decision_trace_completeness_ratio@v1`. Each
...
title: "kpi.decision_trace_completeness_ratio@v1 — decision-trace completeness ratio across playbook branch outcomes (illustrative snapshot)"
---
xychart-beta horizontal
    title "1 = branch outcome carries complete decision trace, 0 = incomplete"
...
The bands match the `thresholds` array on `decision_trace_completeness_ratio.yaml`;
...
declared under `measurement.inputs` on `decision_trace_completeness_ratio.yaml`.
