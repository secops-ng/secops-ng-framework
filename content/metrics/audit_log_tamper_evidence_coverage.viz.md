# Reference visualisation — `kpi.audit_log_tamper_evidence_coverage@v1`

This is the committed reference-visualisation artifact for the
audit-log tamper-evidence coverage across durable audit surfaces KPI.
...
`ratio` aggregate for `kpi.audit_log_tamper_evidence_coverage@v1`. Each
...
title: "kpi.audit_log_tamper_evidence_coverage@v1 — audit-log tamper-evidence coverage across durable audit surfaces (illustrative snapshot)"
---
xychart-beta horizontal
    title "1 = surface carries tamper-evidence signal, 0 = un-attested"
...
The bands match the `thresholds` array on `audit_log_tamper_evidence_coverage.yaml`;
...
declared under `measurement.inputs` on `audit_log_tamper_evidence_coverage.yaml`.
