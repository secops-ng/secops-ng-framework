# Reference visualisation — `kpi.sovereign_object_storage_binding_coverage@v1`

This is the committed reference-visualisation artifact for the
sovereign object-storage binding coverage across compiled artifacts KPI. It exists so the G-04 catalog
...
`ratio` aggregate for `kpi.sovereign_object_storage_binding_coverage@v1`. Each bar plots one observation
...
title: "kpi.sovereign_object_storage_binding_coverage@v1 — sovereign object-storage binding coverage across compiled artifacts (illustrative snapshot)"
---
xychart-beta horizontal
    title "1 = EU/sovereign, 0 = otherwise"
...
The bands match the `thresholds` array on `sovereign_object_storage_binding_coverage.yaml`; the catalog
...
declared under `measurement.inputs` on `sovereign_object_storage_binding_coverage.yaml`. Each observation
