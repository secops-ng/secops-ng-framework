# Reference visualisation — `kpi.golden_test_coverage@v1`

This is the committed reference-visualisation artifact for the golden
byte-parity test coverage across compiled example artifacts KPI. It
...
`ratio` aggregate for `kpi.golden_test_coverage@v1`. Each bar plots
...
title: "kpi.golden_test_coverage@v1 — per-artifact golden coverage (illustrative snapshot)"
---
xychart-beta horizontal
    title "1 = artifact backed by a byte-parity golden, 0 = uncovered"
...
The bands match the `thresholds` array on `golden_test_coverage.yaml`;
...
declared under `measurement.inputs` on `golden_test_coverage.yaml`.
