...
`nis2_incident_final_report_latency_days.yaml` in `playbook_refs`:

- `playbook.incident_management@v1` step `action--50000000-0000-4000-8000-000000000009` — the NIS2 Art. 23(4)(d) one-month final-report dispatch step (co-anchored with the DORA Art. 19(4)(c) final report) of the dual-mandate incident-management chain.
