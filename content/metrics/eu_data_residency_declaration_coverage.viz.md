# Reference visualisation — `kpi.eu_data_residency_declaration_coverage@v1`

This is the committed reference-visualisation artifact for the
EU data-residency declaration coverage across reference deployment surfaces KPI. It exists so the G-04 catalog
...
`ratio` aggregate for `kpi.eu_data_residency_declaration_coverage@v1`. Each bar plots one observation
...
title: "kpi.eu_data_residency_declaration_coverage@v1 — EU data-residency declaration coverage across reference deployment surfaces (illustrative snapshot)"
---
xychart-beta horizontal
    title "1 = declared, 0 = undeclared"
...
The bands match the `thresholds` array on `eu_data_residency_declaration_coverage.yaml`; the catalog
...
declared under `measurement.inputs` on `eu_data_residency_declaration_coverage.yaml`. Each observation
