...
`dora_incident_intermediate_report_latency_hours.yaml` in `playbook_refs`:

- `playbook.incident_management@v1` step `action--50000000-0000-4000-8000-000000000007` — the DORA Art. 19(4)(b) intermediate-report dispatch step (co-anchored with the NIS2 Art. 23 72-hour notification) of the dual-mandate incident-management chain.
