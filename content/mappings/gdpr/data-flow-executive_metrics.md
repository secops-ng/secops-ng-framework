# GDPR data flow — executive_metrics

Per-workflow GDPR data-flow entry for the `executive_metrics`
...
[`content/playbooks/executive_metrics/`](../../playbooks/executive_metrics/).
...
carries personal data (the incident_management workflow's case
store, the post_incident_review workflow's corrective-action
