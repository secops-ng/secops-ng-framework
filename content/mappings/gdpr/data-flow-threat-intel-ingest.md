# GDPR data flow — threat-intel-ingest

Per-workflow GDPR data-flow entry for the `threat-intel-ingest`
...
[`content/playbooks/threat-intel-ingest/`](../../playbooks/threat-intel-ingest/).
...
- **Rectification (Art. 16).** The workflow does not store
  ...
  operator. The operator's downstream incident-management
...
- **Automated decision-making (Art. 22).** The
  ...
  operator's incident-management playbook arbitrates any
