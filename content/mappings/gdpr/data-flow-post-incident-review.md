# GDPR data flow — post-incident-review

Per-workflow GDPR data-flow entry for the `post-incident-review`
...
[`content/playbooks/post-incident-review/`](../../playbooks/post-incident-review/).
...
- The **control-effectiveness rollup** (the
  ...
  operator's executive-metrics rollup.
...
- **Closed corrective-action register entries** age into the
  ...
  expiry on the parent incident-management playbook. The operator
