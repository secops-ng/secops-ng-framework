# GDPR data flow — ransomware_containment

Per-workflow GDPR data-flow entry for the `ransomware_containment`
...
[`content/playbooks/ransomware_containment/`](../../playbooks/ransomware_containment/).
...
- **Triage record and detection-signal context** are linked onto
  ...
  post_incident_review window; bounded by the operator's
  evidence-pack expiry on the incident_management playbook).
