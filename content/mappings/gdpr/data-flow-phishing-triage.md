# GDPR data flow — phishing-triage

Per-workflow GDPR data-flow entry for the `phishing-triage` cookbook
...
[`content/playbooks/phishing-triage/`](../../playbooks/phishing-triage/).
...
- **Triaged-malicious messages** are linked onto the incident case
  ...
  pack expiry on the incident-management playbook).
