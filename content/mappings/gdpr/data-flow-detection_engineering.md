# GDPR data flow — detection_engineering

Per-workflow GDPR data-flow entry for the `detection_engineering`
...
[`content/playbooks/detection_engineering/`](../../playbooks/detection_engineering/).
