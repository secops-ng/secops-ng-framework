...
- **Annex I §2 vulnerability-handling essential requirements**
  (CORE layer) — SBOM, vulnerability handling, coordinated
...
- **Article 13 manufacturer obligations** (CORE layer) —
  ...
  contact (Art.13(12));
- **Article 14 reporting obligations** (CORE layer) — early-warning
...
articles (Art.13(9)–(11) support period and labelling, Art.13(16)
authorised representative, Annex I §3 conformance assessment, Art.10
importer and distributor obligations, Annex II technical documentation)
lands in follow-on layers. Schema-validation and YAML-coverage parity
are enforced by
