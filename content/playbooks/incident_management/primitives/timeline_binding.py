...
The F-WF-05 incident_management workflow signals the F-PT-02
...
class TimelineSession:
    """In-memory representation of an open incident_management timeline.
...
def open_timeline(
    *, incident_id: UUID, opened_at: datetime
    ...
    """Open a new incident_management timeline.
