"""Deterministic response-routing helpers for the alert_triage playbook.
...
* The downstream incident_management playbook reference is pinned to
  ``playbook.incident_management@v1`` — the stable handle the
  follow-up F-WF-04 incident_management workflow will register. Two
...
# Stable handle for the downstream incident_management playbook. Pinned
...
class EscalationDirective:
    ...
    Attributes:
        ...
        incident_management_playbook_ref: Stable handle of the
            downstream incident_management playbook the case hands off
...
def escalation_route(
    *,
    ...
    Returns:
        ...
        downstream incident_management playbook reference, the
...
def notify_on_call(
    ...
    * The downstream incident_management playbook reference is pinned
    ...
    * The verdict carries every reason that fired (ordered) plus a
    ...
    Returns:
        ...
        notification cadence, the downstream incident_management
...
def route_to_review_queue(
    ...
    * The verdict carries every reason that fired (ordered) plus a
    ...
    Returns:
        ...
        review cadence, the downstream incident_management playbook
