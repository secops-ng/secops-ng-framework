...
Regenerate via::
    ...
    python -m compilers.temporal \\
        ...
        > tests/compilers/temporal/golden/executive_metrics_rollup.expected.py
"""
...
GOLDEN = (
    ...
    / "golden"
    / "executive_metrics_rollup.expected.py"
)


def test_executive_metrics_rollup_matches_golden() -> None:
