...
Regenerate via::
    ...
    PYTHONPATH=. python -m tools.compile \\
        ...
        --target n8n \\
        --out tests/compilers/n8n/golden/executive_metrics_rollup.n8n.json
"""
...
GOLDEN = Path(__file__).parent / "golden" / "executive_metrics_rollup.n8n.json"
...
def test_executive_metrics_rollup_golden_matches() -> None:
...
def test_emit_file_writes_golden(tmp_path: Path) -> None:
    out = tmp_path / "executive_metrics_rollup.n8n.json"
