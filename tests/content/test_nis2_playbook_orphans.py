"""Tests for the NIS2 orphan-CI assertion (G-02 KRI, nis2 axis).
...
the shipped ``content/mappings/nis2/`` plus the audited
...
def test_real_tree_passes_orphan_ci() -> None:
    ...
    G-02 floor (nis2 axis) is zero HIGH findings; the assertion fires
            ...
            skip:
              - slug: intentionally_unmapped
                rationale: >-
                  ...
                  no NIS2 edge is appropriate here.
            """
        ),
    )
    findings, summary = check(
