"""Golden tests for the cryptographic_controls worked example.

Pins the three reference-compiler outputs against the bytes that ship
under ``examples/{n8n,temporal,langgraph}/cryptographic_controls/``.
...
commands documented in each ``examples/<target>/cryptographic_controls/README.md``
...
def test_n8n_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "cryptographic_controls n8n example drifted. Regenerate via "
...
def test_temporal_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "cryptographic_controls Temporal example drifted. Regenerate via "
...
def test_langgraph_graph_spec_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "cryptographic_controls LangGraph example drifted. Regenerate via "
