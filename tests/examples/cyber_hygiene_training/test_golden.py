"""Golden tests for the cyber_hygiene_training worked example.

Pins the three reference-compiler outputs against the bytes that ship
under ``examples/{n8n,temporal,langgraph}/cyber_hygiene_training/``.
...
commands documented in each ``examples/<target>/cyber_hygiene_training/README.md``
...
def test_n8n_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "cyber_hygiene_training n8n example drifted. Regenerate via "
...
def test_temporal_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "cyber_hygiene_training Temporal example drifted. Regenerate via "
...
def test_langgraph_graph_spec_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "cyber_hygiene_training LangGraph example drifted. Regenerate via "
