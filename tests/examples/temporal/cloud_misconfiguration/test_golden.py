"""F-G03-PARITY EXTEND — Temporal worked example for cloud_misconfiguration.

Pins the Temporal end of the three-target contract for the ``cloud_misconfiguration``
playbook. The committed ``examples/temporal/cloud_misconfiguration/workflow.temporal.py``
...
EXAMPLE = REPO / "examples" / "temporal" / "cloud_misconfiguration"
SOURCE = REPO / "content" / "playbooks" / "cloud_misconfiguration" / "playbook.cacao.json"
