"""F-G03-PARITY EXTEND — Temporal worked example for identity_compromise.

Pins the Temporal end of the three-target contract for the ``identity_compromise``
playbook. The committed ``examples/temporal/identity_compromise/workflow.temporal.py``
...
EXAMPLE = REPO / "examples" / "temporal" / "identity_compromise"
SOURCE = REPO / "content" / "playbooks" / "identity_compromise" / "playbook.cacao.json"
