"""F-G03-PARITY EXTEND — Temporal worked example for phishing_triage.

Pins the Temporal end of the three-target contract for the
``phishing_triage`` playbook. The committed
``examples/temporal/phishing_triage/workflow.temporal.py`` is
...
EXAMPLE = REPO / "examples" / "temporal" / "phishing_triage"
SOURCE = REPO / "content" / "playbooks" / "phishing_triage" / "playbook.cacao.json"
