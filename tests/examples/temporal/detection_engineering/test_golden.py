...
The committed
``examples/temporal/detection_engineering/evidence/rule-effectiveness-snapshot.json``
...
EXAMPLE = REPO / "examples" / "temporal" / "detection_engineering"
...
def test_example_snapshot_matches_temporal_adapter(tmp_path: Path) -> None:
    ...
    assert written.read_bytes() == SNAPSHOT.read_bytes(), (
        ...
        "`PYTHONPATH=. python examples/temporal/detection_engineering/"
