...
under ``examples/temporal/vuln_intake/evidence/supply-chain/`` against
...
``examples/temporal/vuln_intake/evidence/supply-chain/regenerate.py``.
...
EXAMPLE_DIR = REPO / "examples" / "temporal" / "vuln_intake" / "evidence" / "supply-chain"
GOLDEN = EXAMPLE_DIR / "dependencies-snapshot.json"


# Mirrors CTX in examples/temporal/vuln_intake/evidence/supply-chain/regenerate.py.
...
def _drift_hint() -> str:
    return (
        ...
        "via `PYTHONPATH=. python examples/temporal/vuln_intake/evidence/"
