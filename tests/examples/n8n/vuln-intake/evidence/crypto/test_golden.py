...
under ``examples/n8n/vuln-intake/evidence/crypto/`` against a fresh
...
JSON-native payload ``examples/n8n/vuln-intake/evidence/crypto/regenerate.py``
...
in ``examples/n8n/vuln-intake/evidence/crypto/regenerate.py``. The
...
EXAMPLE_DIR = REPO / "examples" / "n8n" / "vuln-intake" / "evidence" / "crypto"
GOLDEN = EXAMPLE_DIR / "secret-handling-attestation.json"


# Mirrors PAYLOAD in examples/n8n/vuln-intake/evidence/crypto/regenerate.py.
