...
under ``examples/n8n/vuln-intake/evidence/effectiveness/`` against a
...
``examples/n8n/vuln-intake/evidence/effectiveness/regenerate.py``
...
in ``examples/n8n/vuln-intake/evidence/effectiveness/regenerate.py``.
...
EXAMPLE_DIR = (
    REPO / "examples" / "n8n" / "vuln-intake" / "evidence" / "effectiveness"
)
...
PAYLOAD: dict = {
    ...
    "execution_id": "n8n:vuln-intake-effectiveness-example-0001",
    "compile_target": "n8n",
...
def _drift_hint() -> str:
    return (
        ...
        "`PYTHONPATH=. python examples/n8n/vuln-intake/evidence/"
