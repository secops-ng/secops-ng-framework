...
``examples/n8n/vuln_intake/evidence/supply-chain/`` against a fresh
...
``examples/n8n/vuln_intake/evidence/supply-chain/regenerate.py`` ships,
...
in ``examples/n8n/vuln_intake/evidence/supply-chain/regenerate.py``.
...
EXAMPLE_DIR = REPO / "examples" / "n8n" / "vuln_intake" / "evidence" / "supply-chain"
GOLDEN = EXAMPLE_DIR / "dependencies-snapshot.json"


# Mirrors PAYLOAD in examples/n8n/vuln_intake/evidence/supply-chain/regenerate.py.
