"""F-WF-BCR CORE-FANOUT-N8N — drift guard for the n8n backup_recovery example.

Mirrors the ransomware_containment / vuln_intake n8n example tests:
...
SOURCE = REPO_ROOT / "content" / "playbooks" / "backup_recovery" / "playbook.cacao.json"
EXAMPLE = REPO_ROOT / "examples" / "n8n" / "backup_recovery"
