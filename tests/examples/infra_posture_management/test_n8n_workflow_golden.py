"""F-WF-06 CORE-N8N — byte-parity golden for the n8n workflow.

The committed
``examples/n8n/infra_posture_management/workflow.n8n.json`` is the n8n
...
def test_n8n_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "infra_posture_management n8n workflow drifted. Regenerate via "
