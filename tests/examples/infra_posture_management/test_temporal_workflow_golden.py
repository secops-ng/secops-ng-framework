"""F-WF-06 CORE-TEMPORAL — byte-parity golden for the Temporal workflow.
...
def test_worked_example_matches_emitter_output() -> None:
    ...
    assert rendered == expected, (
        "examples/temporal/infra_posture_management/workflow.temporal.py "
...
def test_mirrored_cacao_matches_canonical_source() -> None:
    assert MIRRORED_CACAO.read_bytes() == SOURCE.read_bytes(), (
        "examples/temporal/infra_posture_management/playbook.cacao.json "
