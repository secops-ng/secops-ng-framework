"""Golden tests for the dora_major_incident_reporting worked example.

Pins the three reference-compiler outputs against the bytes that ship
under ``examples/{n8n,temporal,langgraph}/dora_major_incident_reporting/``.
...
commands documented in each ``examples/<target>/dora_major_incident_reporting/README.md``
...
def test_n8n_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "dora_major_incident_reporting n8n example drifted. Regenerate via "
...
def test_temporal_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "dora_major_incident_reporting Temporal example drifted. Regenerate via "
...
def test_langgraph_graph_spec_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "dora_major_incident_reporting LangGraph example drifted. Regenerate via "
