"""Golden tests for the eu_ai_act_risk_management worked example.

Pins the three reference-compiler outputs against the bytes that ship
under ``examples/{n8n,temporal,langgraph}/eu_ai_act_risk_management/``.
...
commands documented in each ``examples/<target>/eu_ai_act_risk_management/README.md``
...
def test_n8n_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "eu_ai_act_risk_management n8n example drifted. Regenerate via "
...
def test_temporal_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "eu_ai_act_risk_management Temporal example drifted. Regenerate via "
...
def test_langgraph_graph_spec_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "eu_ai_act_risk_management LangGraph example drifted. Regenerate via "
