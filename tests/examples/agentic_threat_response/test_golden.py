"""Golden tests for the agentic_threat_response worked example.

Pins the three reference-compiler outputs against the bytes that ship
under ``examples/{n8n,temporal,langgraph}/agentic_threat_response/``.
...
commands documented in each ``examples/<target>/agentic_threat_response/README.md``
...
def test_n8n_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "agentic_threat_response n8n example drifted. Regenerate via "
...
def test_temporal_workflow_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "agentic_threat_response Temporal example drifted. Regenerate via "
...
def test_langgraph_graph_spec_matches_golden() -> None:
    ...
    assert rendered == expected, (
        "agentic_threat_response LangGraph example drifted. Regenerate via "
