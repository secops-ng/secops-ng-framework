#!/usr/bin/env bash
# Regenerate the committed data_protection_impact_assessment LangGraph
...
CANON_YAML="${REPO_ROOT}/content/playbooks/data_protection_impact_assessment/playbook.cacao.yaml"
