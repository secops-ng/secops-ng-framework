# examples/langgraph/vuln-intake/evidence/bundle
...
from the siblings under `examples/langgraph/vuln-intake/evidence/crypto/`
and `examples/langgraph/vuln-intake/evidence/supply-chain/`, so the
...
| `content/evidence/crypto/secret-handling-attestation.json` | copy of `examples/langgraph/vuln-intake/evidence/crypto/`      | F-CP-05 artifact  |
| `content/evidence/supply-chain/dependencies-snapshot.json` | copy of `examples/langgraph/vuln-intake/evidence/supply-chain/` | F-CP-03 artifact |
