#!/usr/bin/env bash
# Regenerate the committed onboarding_offboarding_tracker LangGraph
...
# compilers/langgraph/*.
#
# At the SKELETON layer the per-execution access-evidence artefact
# and the byte-parity golden for it land in the F-WF-11 CORE-FANOUT-LG
