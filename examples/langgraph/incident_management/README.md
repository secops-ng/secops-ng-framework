# incident_management — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the incident_management CACAO playbook (the NIS2 Article 23
...
incident_management playbook without re-platforming: the example shows
...
wave for incident_management completes with this card; the overlay
