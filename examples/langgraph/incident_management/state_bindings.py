...
class PlaybookIncidentManagementV1State(TypedDict, total=False):
    ...
    # Identifier of the originating incident signal handed in by the upstream triage workflow (alert_triage close-out, ransomware_containment close-out, or an operator-raised ticket).
    signal_id: str
