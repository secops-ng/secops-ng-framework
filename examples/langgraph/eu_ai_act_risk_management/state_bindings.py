...
class PlaybookEuAiActRiskManagementV1State(TypedDict, total=False):
    ...
    technical_documentation_id: str
...
async def monitor_post_market_signals() -> str:
    ...
    with _TRACER.start_as_current_span(
        ...
        raise NotImplementedError(
            f"CACAO action tool not implemented: step_id='action--40000000-0000-4000-8000-000000000005'"
        )
