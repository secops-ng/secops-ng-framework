# cloud_misconfiguration — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the cloud_misconfiguration CACAO playbook. It is aimed at an
...
```bash
./examples/langgraph/cloud_misconfiguration/regenerate.sh
```
...
The cloud_misconfiguration playbook branches twice — once to suppress
