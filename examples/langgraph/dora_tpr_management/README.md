# dora_tpr_management — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the dora_tpr_management CACAO playbook. It is aimed at an
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/dora_tpr_management/playbook.cacao.json`, the input to the compiler. |
