# on-call-rotation — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the on-call-rotation CACAO playbook. It is aimed at an integrator
...
The on-call-rotation playbook is reentrant and only emits a handoff
