# post-incident-review — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the post-incident-review CACAO playbook. It is aimed at an
...
The post-incident-review playbook is a linear three-step chain run
