# ransomware_containment — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the ransomware_containment CACAO playbook. It is aimed at an
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/ransomware_containment/playbook.cacao.json`, the input to the compiler. |
...
- [`examples/n8n/ransomware_containment/`](../../n8n/ransomware_containment/) — n8n no-code workflow.
- [`examples/temporal/ransomware_containment/`](../../temporal/ransomware_containment/) — Temporal durable workflow stub.

## Topology

The ransomware_containment playbook branches twice: once on triage
