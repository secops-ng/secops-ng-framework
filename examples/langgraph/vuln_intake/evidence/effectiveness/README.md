# examples/langgraph/vuln_intake/evidence/effectiveness
...
under `examples/langgraph/vuln_intake/evidence/supply-chain/` and
...
```sh
PYTHONPATH=. python examples/langgraph/vuln_intake/evidence/effectiveness/regenerate.py
```
