...
``examples/n8n/codebase_vuln_management/`` and
``examples/temporal/codebase_vuln_management/`` so the per-target
...
# payloads at examples/{n8n,temporal}/codebase_vuln_management/ so the
