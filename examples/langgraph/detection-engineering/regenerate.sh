#!/usr/bin/env bash
# Regenerate the committed detection-engineering LangGraph worked-example
...
CANON_YAML="${REPO_ROOT}/content/playbooks/detection-engineering/playbook.cacao.yaml"
