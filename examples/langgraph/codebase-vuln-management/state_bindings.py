...
class PlaybookCodebaseVulnManagementV1State(TypedDict, total=False):
    ...
    # Pointer to the disclosure-timeline record set produced by track-timeline. One record per finding, shaped against content/evidence/codebase-vuln-management/disclosure-timeline-record.schema.json.
