...
- [`examples/n8n/codebase-vuln-management/`](../../n8n/codebase-vuln-management/) — n8n no-code workflow.
- [`examples/temporal/codebase-vuln-management/`](../../temporal/codebase-vuln-management/) — Temporal durable workflow stub.
...
Per `content/evidence/codebase-vuln-management/disclosure-timeline-record.schema.json`:
