# identity_compromise — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the identity_compromise CACAO playbook. It is aimed at an integrator
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/identity_compromise/playbook.cacao.json`, the input to the compiler. |
...
- [`examples/n8n/identity_compromise/`](../../n8n/identity_compromise/) — n8n no-code workflow.
- [`examples/temporal/identity_compromise/`](../../temporal/identity_compromise/) — Temporal durable workflow stub.

## Topology

The identity_compromise playbook branches on the triage outcome:
...
The conditional-edge router pattern is identical to vuln_intake; see
