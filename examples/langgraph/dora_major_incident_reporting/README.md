# dora_major_incident_reporting — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the dora_major_incident_reporting CACAO playbook. It is aimed at an
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/dora_major_incident_reporting/playbook.cacao.json`, the input to the compiler. |
