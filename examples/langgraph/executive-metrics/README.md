# executive-metrics — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the executive-metrics CACAO playbook. It is aimed at an integrator
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/executive-metrics/playbook.cacao.json`, the input to the compiler. |
...
- [`examples/n8n/executive-metrics/`](../../n8n/executive-metrics/) — n8n no-code workflow.
- [`examples/temporal/executive-metrics/`](../../temporal/executive-metrics/) — Temporal durable workflow stub.

## Topology

The executive-metrics playbook is a periodic KPI/KRI rollup that
