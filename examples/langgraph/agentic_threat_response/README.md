# agentic_threat_response — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the agentic_threat_response CACAO playbook. It is aimed at an
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/agentic_threat_response/playbook.cacao.json`, the input to the compiler. |
