# phishing_triage — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the phishing_triage CACAO playbook. It is aimed at an integrator who
...
| File | Role |
|------|------|
| `playbook.cacao.json` | Portable CACAO v2 playbook — byte-identical mirror of `content/playbooks/phishing_triage/playbook.cacao.json`, the input to the compiler. |
