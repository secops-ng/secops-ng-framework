#!/usr/bin/env bash
# Regenerate the committed contractual_obligations_tracker LangGraph
...
# compilers/langgraph/*.
#
# At the SKELETON layer the per-execution obligation-evidence artefact
# and the byte-parity golden for it land in the F-WF-10 CORE-FANOUT-LG
# sibling card Aurora queues after this SKELETON merges. The workflow
# graph itself is fully emitted at the SKELETON layer because the CACAO
