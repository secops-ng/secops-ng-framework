"""Regenerate the committed detection_engineering rule-effectiveness snapshot (LangGraph).
...
``examples/n8n/detection_engineering/regenerate.py`` and
``examples/temporal/detection_engineering/regenerate.py`` so the
...
# payloads at examples/{n8n,temporal}/detection_engineering/ so the
