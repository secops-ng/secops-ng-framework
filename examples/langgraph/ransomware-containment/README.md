# ransomware-containment — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the ransomware-containment CACAO playbook. It is aimed at an
...
The ransomware-containment playbook branches twice: once on triage
