#!/usr/bin/env bash
# Regenerate the committed n8n worked-example artifact for the
# F-SV-02 EUDIW typed-input pattern. Run from the repo root after any
# change to ``patterns/eidas2_wallet/`` or the n8n adapter under
...
# typed_input/ via the n8n pattern adapter.
