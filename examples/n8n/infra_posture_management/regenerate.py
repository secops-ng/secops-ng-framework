"""Regenerate scaffold for examples/n8n/infra_posture_management.
...
no-op pending the F-WF-06 CORE-FANOUT-N8N sibling card.
...
``schemas/evidence/posture.schema.json``) when CORE-FANOUT-N8N lands.
"""
...
def main() -> None:
    ...
    print(
        f"infra_posture_management (n8n): mirrored canonical CACAO source -> "
        f"{MIRROR.relative_to(REPO_ROOT)}."
    )
    print("Workflow emission and posture-evidence artefact deferred to F-WF-06 CORE-FANOUT-N8N.")
