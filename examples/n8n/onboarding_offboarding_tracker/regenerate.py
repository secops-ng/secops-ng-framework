"""Regenerate scaffold for examples/n8n/onboarding_offboarding_tracker.

F-WF-11 SKELETON-FANOUT-N8N: scaffold-only. At this layer the canonical
...
n8n compiler emitter binding to drive and no representative
...
F-WF-11 CORE-FANOUT-N8N sibling card.
...
def main() -> None:
    ...
    print(
        f"onboarding_offboarding_tracker (n8n): mirrored canonical CACAO source -> "
        f"{MIRROR.relative_to(REPO_ROOT)}."
    )
    print("Workflow emission and access-evidence artefact deferred to F-WF-11 CORE-FANOUT-N8N.")
