...
golden under `tests/examples/n8n/onboarding_offboarding_tracker/` at
this layer. The compiler emitter, the per-execution evidence
artifact, and the byte-parity golden land in the F-WF-11
CORE-FANOUT-N8N sibling card queued serially after this SKELETON
...
| `evidence/`                | (per-execution output)   | Placeholder; representative access-evidence artifact lands in CORE-FANOUT-N8N |
...
emission land in F-WF-11 CORE-FANOUT-N8N.
...
compile-target binding lands in F-WF-11 CORE-FANOUT-N8N.
