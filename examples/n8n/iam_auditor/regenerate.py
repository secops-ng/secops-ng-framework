"""Regenerate the committed iam_auditor access-evidence artifact (n8n).

F-WF-08 SKELETON-FANOUT-N8N — the iam_auditor capability-inventory
...
``examples/n8n/iam_auditor/evidence/``.
