...
Equivalent direct invocation:
    ...
    PYTHONPATH=. python -m tools.compile \
        content/playbooks/iam-auditor/playbook.cacao.json \
        --target n8n \
        --out examples/n8n/iam-auditor/workflow.n8n.json
...
`tests/examples/n8n/iam-auditor/test_golden.py` pins the committed
...
under `tests/examples/n8n/iam-auditor/test_golden.py` pins both the
