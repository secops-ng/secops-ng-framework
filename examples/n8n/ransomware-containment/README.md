# ransomware-containment — n8n worked example

End-to-end demonstration of the SecOps-NG n8n reference compiler on the
ransomware-containment CACAO playbook. It is aimed at an integrator who
...
The ransomware-containment playbook branches twice, then converges on a
