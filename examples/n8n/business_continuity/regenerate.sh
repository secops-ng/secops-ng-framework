...
# mirrors the source into a byte-deterministic JSON form (sorted keys,
# 2-space indent, trailing newline) so the parity test has a stable
# JSON companion to compare against the sibling targets.
set -euo pipefail
