...
The vulnerability-intake playbook compiled to n8n exercises the
...
``examples/n8n/vuln_intake/evidence/{supply-chain,crypto}/``. This
...
Streams the vuln_intake workflow does not exercise (risk-analysis,
...
or the n8n adapter::
    ...
    PYTHONPATH=. python examples/n8n/vuln_intake/evidence/bundle/regenerate.py
...
# n8n vuln_intake compile target. The bundle inlines copies of these
# under its own ``content/evidence/<stream>/`` tree so the bundle
...
PAYLOAD: dict = {
    ...
    "bundle_window_start": "2026-04-01T00:00:00Z",
    "bundle_window_end": "2026-06-30T23:59:59Z",
    "regulation_refs": [
        "nis2:art-20",
        "nis2:art-21-2-d",
        "nis2:art-21-2-h",
