...
Equivalent direct invocation:
    ...
    PYTHONPATH=. python -m tools.compile \
        content/playbooks/iam_auditor/playbook.cacao.json \
        --target temporal \
        --out examples/temporal/iam_auditor/workflow.temporal.py
...
`tests/examples/temporal/iam_auditor/test_golden.py` pins the
...
under `tests/examples/temporal/iam_auditor/test_golden.py` pins both
