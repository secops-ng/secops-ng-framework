# examples/temporal/vuln_intake/evidence/effectiveness
...
under `examples/temporal/vuln_intake/evidence/supply-chain/` and
`examples/temporal/vuln_intake/evidence/crypto/`.
...
```sh
PYTHONPATH=. python examples/temporal/vuln_intake/evidence/effectiveness/regenerate.py
```
