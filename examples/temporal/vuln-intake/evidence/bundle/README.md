# examples/temporal/vuln-intake/evidence/bundle
...
from the siblings under `examples/temporal/vuln-intake/evidence/crypto/`
and `examples/temporal/vuln-intake/evidence/supply-chain/`, so the
...
| `content/evidence/crypto/secret-handling-attestation.json` | copy of `examples/temporal/vuln-intake/evidence/crypto/`      | F-CP-05 artifact  |
| `content/evidence/supply-chain/dependencies-snapshot.json` | copy of `examples/temporal/vuln-intake/evidence/supply-chain/` | F-CP-03 artifact |
...
PYTHONPATH=. python examples/temporal/vuln-intake/evidence/bundle/regenerate.py
```
