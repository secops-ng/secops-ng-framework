"""Regenerate the committed detection-engineering rule-effectiveness snapshot (Temporal).

F-WF-04 CORE-TEMPORAL — the detection-engineering rule lifecycle
...
``examples/n8n/detection-engineering/regenerate.py`` so the per-target
