...
the same shape as `content-model/examples/vuln-intake/` and
`content-model/examples/data-exfil/`. Ties together every layer that
...
|--------------|-------------------------------------------------------|-------------------------------------------------|
| Playbook     | `../../../content/playbooks/post-incident-review/playbook.cacao.json` | `playbook.post_incident_review@v1`              |
...
- LangGraph: `examples/langgraph/post-incident-review/` plus
...
Note on metric set: vuln-intake and data-exfil carry detection-shaped
...
- Compiler outputs (`examples/{n8n,temporal,langgraph}/post-incident-review/`)
