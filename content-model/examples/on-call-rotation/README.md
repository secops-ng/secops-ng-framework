...
Detection, triage, containment, and post-incident-review playbooks
...
- LangGraph: `examples/langgraph/on-call-rotation/` plus
...
- Compiler outputs (`examples/{n8n,temporal,langgraph}/on-call-rotation/`)
