...
content model, following the same shape as `examples/vuln_intake/`. It
...
|-------------|-------------------------------------------------------|----------------------------------------------------|
| Playbook    | `../../../content/playbooks/data_exfil/playbook.cacao.json` | `playbook.data_exfil@v1`                     |
...
against its layer schema. The data_exfil playbook also parses cleanly
...
- Compiler outputs (`examples/{n8n,temporal,langgraph}/data_exfil/`) and
