...
`content-model/examples/data-exfil/`. Ties together every layer
...
and `content-model/examples/executive-metrics-rollup/langgraph/`.

Note on metric set: vuln-intake and data-exfil carry four KPI/KRI
