# executive-metrics-rollup — LangGraph worked example

End-to-end demonstration of the SecOps-NG LangGraph reference compiler
on the executive-metrics-rollup CACAO playbook. It is aimed at an
...
```bash
./content-model/examples/executive-metrics-rollup/langgraph/regenerate.sh
```
