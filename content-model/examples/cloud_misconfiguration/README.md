...
|--------------|-----------------------------------------------------------|----------------------------------------------------|
| Playbook     | `../../../content/playbooks/cloud_misconfiguration/playbook.cacao.json` | `playbook.cloud_misconfiguration@v1`               |
...
The cloud_misconfiguration playbook is named in the NIS2 and DORA
...
- Compiler outputs (`examples/{n8n,temporal,langgraph}/cloud_misconfiguration/`)
