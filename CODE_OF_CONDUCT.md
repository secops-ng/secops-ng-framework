...
Europe. The commons works because the people in it treat one another
with care. This document sets out what that means in practice and what
happens when the agreement breaks down.

Adapted from the [Contributor Covenant, version 2.1][cc-2.1].

## 1. Our pledge

We — as members, contributors, and stewards of this commons — pledge
to make participation a harassment-free experience for everyone,
...
Behaviour that helps the commons:

- Showing empathy and kindness toward other people.
- Being respectful of differing opinions, viewpoints, and experiences.
- Giving and gracefully accepting constructive feedback.
- Taking responsibility, apologising to those affected by mistakes,
  and learning from the experience.
- Focusing on what is best not only for ourselves as individuals but
  for the wider community.

Behaviour that harms the commons:
...
- Publishing other people's private information — physical address,
  email address, employer, immigration status — without their explicit
  permission.
...
discussions, issue trackers, pull request reviews, chat channels,
mailing lists, video calls, and events — and also when an individual
is officially representing the community in public spaces. Examples
of representation include using an official email address, posting via
an official social media account, or acting as an appointed
representative at an online or offline event.

## 4. Enforcement responsibilities — the stewards

A small group of **stewards** is responsible for clarifying and
enforcing the standards in this document. Stewards are members of the
community who have accepted that responsibility on behalf of the
commons.

Stewards have the authority to remove, edit, or reject comments,
...
If you experience or witness behaviour that breaks this Code of
Conduct, you can report it to the stewards at:

**conduct@secops-ng.com**
...
turns out to be fine than for harm to go unaddressed.

## 6. Enforcement guidelines

Stewards follow these guidelines when deciding the consequences for
any action they judge to be in violation of this Code of Conduct.
...
**Consequence:** A private, written notice from the stewards
