# alert-triage — cookbook walkthrough
...
```
content/playbooks/
├── alert-triage.cacao.yaml          # canonical CACAO v2 source
└── alert-triage/
...
The canonical YAML is in `content/playbooks/alert-triage.cacao.yaml`
rather than nested under `content/playbooks/alert-triage/`. Whether
...
in `content/playbooks/alert-triage/primitives/`. Operators who need to
...
:   The p1-severe response step produces the page + escalate directive
    (paging tier + escalation handoff to the incident-management
...
`examples/n8n/alert-triage/workflow.n8n.json` carries the CACAO
...
[`examples/n8n/alert-triage/README.md`](../../examples/n8n/alert-triage/README.md)
under *Per-action wiring notes — CORE bodies*.

### 4.2 Temporal — `@activity.defn` bodies with retry policy

`examples/temporal/alert-triage/workflow.temporal.py` is a standard
...
`examples/langgraph/alert-triage/state_bindings.py` carries the
...
- [`content/playbooks/alert-triage.cacao.yaml`](../../content/playbooks/alert-triage.cacao.yaml)
  — canonical CACAO source.
- [`content/playbooks/alert-triage/README.md`](../../content/playbooks/alert-triage/README.md)
  — workflow-local module tree.
- [`examples/n8n/alert-triage/README.md`](../../examples/n8n/alert-triage/README.md)
- [`examples/temporal/alert-triage/README.md`](../../examples/temporal/alert-triage/README.md)
- [`examples/langgraph/alert-triage/README.md`](../../examples/langgraph/alert-triage/README.md)
- [`docs/observability/audit-mirror.md`](../observability/audit-mirror.md)
