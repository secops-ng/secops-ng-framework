...
| `soc2_evidence_collector` | [`soc2_evidence_collector.md`](soc2_evidence_collector.md) | `content/playbooks/soc2_evidence_collector/`       |
...
| `ai_human_oversight` | [`ai_human_oversight.md`](ai_human_oversight.md) | `content/playbooks/ai_human_oversight/` |
